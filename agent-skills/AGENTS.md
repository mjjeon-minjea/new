...
### Lifecycle Mapping & Slash Commands

**Antigravity** and advanced agents support slash commands like `/spec` or `/plan` by mapping them to their respective skills. 

When the user enters a slash command (e.g. `/plan` or `/PLAN`), the agent immediately retrieves and follows the target skill:

- `/spec` → `skills/spec-driven-development/SKILL.md` (Define Phase)
- `/plan` → `skills/planning-and-task-breakdown/SKILL.md` (Plan Phase)
- `/build` → `skills/incremental-implementation/SKILL.md` (Build Phase)
- `/test` → `skills/test-driven-development/SKILL.md` (Verify Phase)
- `/review` → `skills/code-review-and-quality/SKILL.md` (Review Phase)
- `/code-simplify` → `skills/code-simplification/SKILL.md` (Simplify Phase)
- `/ship` → `skills/shipping-and-launch/SKILL.md` (Ship Phase)
